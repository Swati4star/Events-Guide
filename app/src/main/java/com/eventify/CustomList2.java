 ...
 */
public class CustomList2 extends ArrayAdapter<Restaurant> {
    private final ArrayList<Restaurant> restaurants;
    private final Activity context;

    public CustomList2(Activity context, ArrayList<Restaurant> res) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.restaurant_layout, null);
