 ...
 */
public class CustomList_shop extends ArrayAdapter<Restaurant> {
    private final ArrayList<Restaurant> restaurants;
    private final Activity context;

    public CustomList_shop(Activity context, ArrayList<Restaurant> res) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.shop_layout, null);
